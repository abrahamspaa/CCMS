...
export interface paths {
    ...
    "/items/form_components": {
      /**
       * List Items
       * @description List the form_components items.
       */
      get: operations["readItemsFormComponents"];
      /**
       * Create an Item
       * @description Create a new form_components item.
       */
      post: operations["createItemsFormComponents"];
      /**
       * Delete Multiple Items
       * @description Delete multiple existing form_components items.
       */
      delete: operations["deleteItemsFormComponents"];
      /**
       * Update Multiple Items
       * @description Update multiple form_components items at the same time.
       */
      patch: operations["updateItemsFormComponents"];
    };
    "/items/form_components/{id}": {
      /**
       * Retrieve an Item
       * @description Retrieve a single form_components item by unique identifier.
       */
      get: operations["readSingleItemsFormComponents"];
      /**
       * Delete an Item
       * @description Delete an existing form_components item.
       */
      delete: operations["deleteSingleItemsFormComponents"];
      /**
       * Update an Item
       * @description Update an existing form_components item.
       */
      patch: operations["updateSingleItemsFormComponents"];
    };
    "/items/form_submits": {
      /**
       * List Items
       * @description List the form_submits items.
       */
      get: operations["readItemsFormSubmits"];
      /**
       * Create an Item
       * @description Create a new form_submits item.
       */
      post: operations["createItemsFormSubmits"];
      /**
       * Delete Multiple Items
       * @description Delete multiple existing form_submits items.
       */
      delete: operations["deleteItemsFormSubmits"];
      /**
       * Update Multiple Items
       * @description Update multiple form_submits items at the same time.
       */
      patch: operations["updateItemsFormSubmits"];
    };
    "/items/form_submits/{id}": {
      /**
       * Retrieve an Item
       * @description Retrieve a single form_submits item by unique identifier.
       */
      get: operations["readSingleItemsFormSubmits"];
      /**
       * Delete an Item
       * @description Delete an existing form_submits item.
       */
      delete: operations["deleteSingleItemsFormSubmits"];
      /**
       * Update an Item
       * @description Update an existing form_submits item.
       */
      patch: operations["updateSingleItemsFormSubmits"];
    };
    "/items/forms": {
      /**
       * List Items
  ...
  export interface components {
    schemas: {
      ...
      ItemsFormSubmits: {
        ...
        date_created?: string | null;
        user_updated?: string | components["schemas"]["Users"] | null;
        date_updated?: number | components["schemas"]["ItemsForms"] | null;
      ...
      ItemsForms: {
        ...
        elements?: string;
        submits?: (number | components["schemas"]["ItemsFormSubmits"])[];
      };
      Activity: {
        /**
  ...
  export interface operations {
    ...
    readItemsFormComponents: {
      ...
      responses: {
        ...
        200: {
          content: {
            "application/json": {
              data?: components["schemas"]["ItemsFormComponents"][];
    ...
    createItemsFormComponents: {
      ...
      requestBody?: {
        content: {
          "application/json": components["schemas"]["ItemsFormComponents"][] | components["schemas"]["ItemsFormComponents"];
        };
      };
      responses: {
        /** @description Successful request */
     ...
     * @description Delete an existing form_components item.
     */
    deleteSingleItemsFormComponents: {
      parameters: {
        path: {
          /** @description Index of the item. */
          id: number | string;
     ...
     * @description Update an existing form_components item.
     */
    updateSingleItemsFormComponents: {
      parameters: {
        query?: {
          fields?: components["parameters"]["Fields"];
          meta?: components["parameters"]["Meta"];
      ...
      requestBody?: {
        content: {
          "application/json": components["schemas"]["ItemsFormComponents"];
        };
      };
      responses: {
        /** @description Successful request */
    ...
    readItemsFormSubmits: {
      ...
      responses: {
        ...
        200: {
          content: {
            "application/json": {
              data?: components["schemas"]["ItemsFormSubmits"][];
              meta?: components["schemas"]["x-metadata"];
            };
          };
        };
    ...
    createItemsFormSubmits: {
      ...
      requestBody?: {
        content: {
          "application/json": components["schemas"]["ItemsFormSubmits"][] | components["schemas"]["ItemsFormSubmits"];
        };
      };
      responses: {
        /** @description Successful request */
    ...
    updateSingleItemsFormSubmits: {
      ...
      requestBody?: {
        content: {
          "application/json": components["schemas"]["ItemsFormSubmits"];
        };
      };
      responses: {
        /** @description Successful request */
  ...
  export type MyCollections = {
    form_components: components["schemas"]["ItemsFormComponents"][];
    form_submits: components["schemas"]["ItemsFormSubmits"][];
